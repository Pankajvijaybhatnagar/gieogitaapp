    ...
    <View style={S.root}>
      ...
      {showContent && (
        <Animated.View style={[S.contentWrap, { opacity: fadeAnim }]}>
          ...
          {/* ── APP NAME ── */}
          <Animated.Text
            style={[S.appName, { transform: [{ translateY: titleSlide }] }]}>
            GIEO GITA
          </Animated.Text>
          ...
          {/* Tagline */}
          <Animated.Text
            style={[S.tagline, { transform: [{ translateY: subtitleSlide }] }]}>
            Spreading the timeless wisdom of Bhagwad Gita
          </Animated.Text>
          ...
          <Animated.View
            style={{ transform: [{ scale: btnPulse }, { scale: btnScale }] }}>
            <Pressable
