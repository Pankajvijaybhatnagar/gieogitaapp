...
const styles = StyleSheet.create({
  ...
  heroBlob1: {
    ...
    backgroundColor: 'rgba(201,162,39,0.06)', top: -100, right: -80,
  },
  heroBlob2: {
    position: 'absolute', width: 180, height: 180, borderRadius: 90,
    backgroundColor: 'rgba(74,44,13,0.2)', bottom: -60, left: -50,
  },
  heroArc: {
    position: 'absolute', width: 340, height: 340, borderRadius: 170,
    borderWidth: 1, borderColor: 'rgba(201,162,39,0.06)', top: -100, left: -80,
  },
  heroOm: {
    position: 'absolute', right: 24, top: 60,
    fontSize: 90, color: 'rgba(201,162,39,0.05)', lineHeight: 100,
  },
  ...
  topBarTitleText: { fontSize: 12, fontWeight: '800', color: C.goldLight, letterSpacing: 3 },
