  ...
  return (
    <View style={styles.contactBox}>
      ...
      <Text style={styles.contactDesc}>
        For large donations, custom sevas or special occasions, our seva team is
        happy to assist you personally.
      </Text>
      <View style={styles.contactRow}>
        <TouchableOpacity
          style={styles.contactBtn}
          onPress={() => Linking.openURL('tel:+917027101899')}
          activeOpacity={0.85}>
        ...
        <TouchableOpacity
          ...
          onPress={() => Linking.openURL('https://wa.me/917027101899')}
          activeOpacity={0.85}>
          <FontAwesome name="whatsapp" size={13} color={C.white} />
          <Text style={[styles.contactBtnText, { color: C.white }]}>
            WhatsApp
          </Text>
        </TouchableOpacity>
      </View>
